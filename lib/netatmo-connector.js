...
class NetatmoController extends EventEmitter {
    ...
    constructor(options = {
        ...
        if (this.options.verbose) {
            log("NetatmoController constructor options: ", options);
        }
    }
    ...
    getAccessToken() {
        ...
        if (this.options.verbose) {
            log("  Getting access token. params:", params);
        }
        ...
        req.on('error', e => log('There is a problem with your request:', e.message));
